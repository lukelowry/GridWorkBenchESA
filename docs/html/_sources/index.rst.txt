...
Grid Workbench Documentation
================================

Grid Workbench is a convenience package for quick-scripting with 
power-flow related studies. The primary goal of the package is to provide 
user's with an intuitive, hastle-free interface to perform all of 
power world's actions through the python interface.
